...
namespace StrongFitGym.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public PersonalsController(Contexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PersonalID,Name,Speciality")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PersonalID,Name,Speciality")] Personal personal)
        {
